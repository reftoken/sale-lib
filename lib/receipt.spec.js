...
describe('receipt + signer ', () => {
  ...
  it('should allow to sign and parse investment receipt.', (done) => {
    const investReceipt = 'AoYP.aCOc+lACBoy8oRYNFvR78iw0spnhdxLEYax+AD3rf9A=.KaBRThcMd12LrojJqKEKeRq+Ww0gFQSkQTDr3MwjqaQ=.G5mqu8zd7v8AESIzIiIiIiIiIiIiIiIiIiIiIiIiIiI=.AAAAAAAA1VaXywLSMzMzMzMzMzMzMzMzMzMzMzMzMzM=';
    const saleAddr = '0x00112233445566778899aabbccddeeff00112233';
    const investorAddr =  '0x2222222222222222222222222222222222222222';
    const affiliateAddr = '0x3333333333333333333333333333333333333333';
    const oobpa = 234567890567890;
    const invest = new Receipt(saleAddr).investment(investorAddr, affiliateAddr, oobpa);
    // test signing
    expect(invest.sign(PRIV)).to.eql(investReceipt);
    // test parse
    const investParams = ['0x68239cfa5002068cbca1160d16f47bf22c34b299e17712c461ac7e003deb7fd0', '0x29a0514e170c775d8bae88c9a8a10a791abe5b0d201504a44130ebdccc23a9a4', '0x1b99aabbccddeeff001122332222222222222222222222222222222222222222', '0x000000000000d55697cb02d23333333333333333333333333333333333333333'];
